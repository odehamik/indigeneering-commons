---
title: "THE INDIGENEERING OPERATING MANUAL"
subtitle: "building Chaga in the Machine — a mycelial restoration engine"
version: "v1.2 — Maya's review folded in (2026-06-14): On The Name + the two-page wondering APPROVED; Two Row Wampum (Kaswenta) teaching added to the two-page section (cited Fallout 250); short front nod to building Substrate Two/MythOS first (~a year) before the LLM; the §2 wondering re-led with the wound + birch + chaga + mycelial material, corpus-outranks-dictionary folded in as part of the wound; semaa clarified as a HUMAN act; gloss-range beat added (sanagad = dear/hard); four-party agreement added to §8 (cited Fallout 250 birchbark tablet); the museum-bundle teacher renamed 'a beautiful teacher'; no Anishinaabemowin terms in the glossary (Maya's call). Prior v1.1: engineering front-load, mycelial fasteners, co-author corpus, no emojis."
author: "Maya Chacaby (Architect Source Root Operator). The source-relationship is not anyone else's to claim."
audience: "community-first edition, and a wow-the-build-people edition. NOT the academic published piece (that comes later)."
form: "two-register facing pages. LEFT = THE MANUAL (deadpan, lean). RIGHT = THE WONDERING (Maya's theoretical register; theory as equipment, Elders above the theorists, the braid, untranslated constellations held). The gutter is the interstice. They face; they never merge."
labor_law: "LEFT = machine-drafted, hard. RIGHT = MAYA's voice, written here as CANDIDATE in her method, hers to gut. Every place her Anishinaabemowin belongs is a marked [MAYA] opening — the machine does not generate the language. That refusal is the manual obeying its own first law mid-draft."
firewalls: "humour targets the apparatus ONLY · hold the sacred (named-never-explained; silence where the sacred begins) · candidate, not canon — Maya rules every line."
date: 2026-06-14
---
...
![Fig. 2 — passing the thread through bark](figures/fig-02-birch-bark-threading.png)
...
![Fig. 3 — chaga conk on birch, cross-section](figures/fig-03-chaga-cross-section.png)
...
![Fig. 4 — propagation and deployment](figures/fig-04-propagation-deployment.png)
...
![Fig. 5 — the alignment gate, drawn as a curve](figures/fig-05-alignment-gate-histogram.png)
